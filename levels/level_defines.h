...
DEFINE_LEVEL("OW2 IN CASTLE", LEVEL_CASTLE, COURSE_NONE, castle_inside, inside, 20000, 0x40, 0x20, 0x30, _, sCamCastle) 
...
DEFINE_LEVEL("CHARACTER_SELECT", LEVEL_CHARACTER_SELECT, COURSE_NONE, character_select, generic, 20000, 0x00, 0x00, 0x00, _, _) 
