...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(MODEL_STONE_BRIDGE,                          /*pos*/     0, 1000,     0, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStoneBridge),
    OBJECT(MODEL_STONE_BRIDGE,                          /*pos*/   200, 1000,     0, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStoneBridge),
    OBJECT(MODEL_STONE_BRIDGE,                          /*pos*/   200, 1000,   200, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStoneBridge),
    OBJECT(MODEL_STONE_BRIDGE,                          /*pos*/     0, 1000,   200, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStoneBridge),
    RETURN(),
};
...
const LevelScript level_castle_grounds_entry[] = {
    ...
    LUIGI_POS(/*area*/ 1, /*yaw*/ 180, /*pos*/ -1378, 260, 4664),
