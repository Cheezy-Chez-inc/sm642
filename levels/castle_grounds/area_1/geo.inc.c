...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 572, 0, 0, -180, 0, 0, castle_grounds_dl_castle_grounds_seg7_us_dl_0700F2E8_mesh_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_castle_grounds_seg7_us_dl_0700F2E8_mesh_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_grounds_dl_castle_grounds_seg7_us_dl_0700F2E8_mesh_mesh_layer_5),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
