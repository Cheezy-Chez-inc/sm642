...
int gSoundTable[NUM_SOUNDS] = {
    ...
    SOUND_LUIGI_HAHA,
    SOUND_LUIGI_HAHA_WATER,
    SOUND_LUIGI_UH_LEDGE_CLIMB_FAST,
    SOUND_LUIGI_UH_LONG_JUMP_LAND,
    SOUND_LUIGI_ON_FIRE,
    SOUND_LUIGI_DYING,
    ...
    SOUND_WARIO_HAHA,
    SOUND_WARIO_HAHA_WATER,
    SOUND_WARIO_UH_LEDGE_CLIMB_FAST,
    SOUND_WARIO_UH_LONG_JUMP_LAND,
    SOUND_WARIO_ON_FIRE,
    SOUND_WARIO_DYING,
